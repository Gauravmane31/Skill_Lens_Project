...
function LandingPage({ onGetStarted, onLogin }) {
  ...
  return (
    <div style={{ background: C.bg, overflowY: "auto", flex: 1 }}>
      ...
      <section
        style={{
          background: `linear-gradient(135deg, ${C.dark} 0%, #1e1b4b 60%, #312e81 100%)`,
          padding: isMobile ? "56px 20px 48px" : "80px 24px 72px",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        >
          ...
          >
            ...
            >
              AI-Powered Coding Evaluation Platform
            </span>
          </div>
          <h1
            style={{
          ...
          >
            Solve real coding challenges, get AI-powered integrity scoring, earn
            verifiable certificates, and get matched to live job openings — all
            in one platform.
          </p>
          <div
            style={{
          ...
          <p style={{ fontSize: 12, color: "#64748b" }}>
            No credit card required · Free forever for 2 challenges · Instant
            results
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          {[
            {
              v: "12",
              l: "Practice Challenges",
              sub: "Across 8 categories",
              a: C.indigo,
            },
            {
              v: "15",
              l: "Global Leaderboard",
            ...
            },
            {
              v: "12+",
              l: "Live Job Openings",
              sub: "Matched to your score",
              a: C.green,
            },
            {
              v: "100%",
              l: "Verified Certificates",
              sub: "Shareable on LinkedIn",
              a: C.amber,
            },
          ].map((s) => (
            <div
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          >
            A complete evaluation ecosystem — from first keystroke to job offer.
          </p>
        </div>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", position: "relative" }}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <p style={{ color: "#64748b", fontSize: 14 }}>
              Takes less than an hour. Results last a lifetime.
            </p>
          </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  position: "relative",
                  border: `1px solid ${locked ? "#E2E8F0" : C.indigo + "26"}`,
                  boxShadow: "0 1px 3px rgba(0,0,0,.05)",
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          >
            Trusted by Developers Who Got Hired
          </h2>
          ...
          {[
            {
              ...
              avatar: "RV",
              text: "SkillLens showed recruiters my actual abilities. Got my offer in just 3 weeks.",
              stars: 5,
            },
            {
              name: "Emma Clarke",
              role: "Junior Dev · Shopify",
              avatar: "EC",
              text: "The AI feedback pinpointed exactly what I was doing wrong. Total game-changer.",
              stars: 5,
            },
            {
              name: "David Kim",
              role: "SWE II · Google",
              avatar: "DK",
              text: "Integrity score gave me confidence to share results publicly. Huge credibility boost.",
              stars: 5,
            },
            {
              name: "Ananya Nair",
              role: "Engineering Intern · Freshworks",
              avatar: "AN",
              text: "As a fresher, the certificate helped me stand out from 500+ applicants.",
              stars: 5,
            },
          ].map((t) => (
            <div
            ...
            >
              <div style={{ display: "flex", gap: 2, marginBottom: 12 }}>
                {"★★★★★".split("").map((_, i) => (
                  <span key={i} style={{ fontSize: 14, color: C.amber }}>
                    ★
                  </span>
                ))}
              </div>
      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              Join thousands of developers earning certificates that actually
