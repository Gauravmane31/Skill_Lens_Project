    ...
    <div style={{ overflowY: "auto", flex: 1, background: C.bg }}>
      {!parseSuccess && !file ? (
        <div
          style={{
            background:
              "linear-gradient(135deg,#5B5FED 0%,#8B8FF8 50%,#1C1C2E 100%)",
      ...
      >
        ...
        >
          ...
          >
            <div>
              <h2 style={{ fontWeight: 900, fontSize: 15, margin: "0 0 2px" }}>
                📄 Upload Resume
              </h2>
        ...
        <div className="sl-two-col">
          ...
          <div>
            ...
            {activeTab === "personal" && (
              <Card>
                <h3
                  style={{ fontWeight: 800, fontSize: 15, margin: "0 0 14px" }}
                >
                  👤 Personal Info
                </h3>
            ...
            {activeTab === "experience" && (
              <Card>
                ...
                >
                  <h3 style={{ fontWeight: 800, fontSize: 15, margin: 0 }}>
                    💼 Experience
                  </h3>
                  <button
                    onClick={() =>
            ...
            {activeTab === "skills" && (
              <Card>
                <h3
                  style={{ fontWeight: 800, fontSize: 15, margin: "0 0 16px" }}
                >
                  ⚡ Skills & Languages
                </h3>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <Card>
              <h4 style={{ fontWeight: 800, fontSize: 13, margin: "0 0 10px" }}>
                💡 Profile Tips
              </h4>
              {[
                {
