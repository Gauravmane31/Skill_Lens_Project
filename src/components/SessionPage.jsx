...
const LazyProctoring = React.lazy(() => import("./Proctoring.jsx"));
  ...
  if (!challenge)
    return (
      ...
      >
        ...
        <h3 style={{ fontWeight: 800, color: C.text }}>
          ...
          {activeTab === "problem" && (
            <>
              ...
              >
                ...
                <div>
                  <h2
                    style={{ fontWeight: 900, fontSize: 15, margin: "0 0 3px" }}
                  >
                    {challenge.title}
                  </h2>
              ...
              >
                ...
                {[
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 800, color: C.indigo }}>
                      {v}
                    </span>
                  </div>
                ))}
        ...
        >
              ...
              (l) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 7,
                    border: "none",
                    background: lang === l ? C.indigo : "#1e1e30",
          ...
          <div style={{ display: "flex", gap: 6 }}>
            <button
              ...
              style={{
                padding: "6px 13px",
                background: running ? "#1e1e30" : C.green,
                color: "#fff",
                border: "none",
                borderRadius: 8,
                fontWeight: 700,
          ...
          {!showStdin && (
            <div style={{ flex: 1, overflowY: "auto", padding: "10px 16px" }}>
              {running ? (
                ...
                <div
                  style={{ color: "#333", fontSize: 12, fontStyle: "italic" }}
                >
