...
::-webkit-scrollbar-thumb{background:#D2D2CE;border-radius:99px;}
...
.sl-prob-pane{width:340px;background:#fff;border-right:1px solid #E4E4E1;overflow-y:auto;flex-shrink:0;}
.sl-card-hover{transition:transform .15s,border-color .15s;}
.sl-card-hover:hover{transform:translateY(-2px);border-color:#D2D2CE !important;}
...
@media(max-width:639px){
  ...
  .sl-mob-menu.open{display:flex;flex-direction:column;position:fixed;top:62px;left:0;right:0;background:#12141C;border-bottom:1px solid rgba(255,255,255,.08);z-index:999;padding:10px;gap:4px;box-shadow:0 6px 24px rgba(0,0,0,.3);}
  .sl-session{flex-direction:column !important;}
  .sl-prob-pane{width:100% !important;border-right:none !important;border-bottom:1px solid #E4E4E1 !important;max-height:250px !important;padding:14px !important;}
