...
function PublicNav({ onLogin, onSignup, onLogoClick }) {
  ...
  const scrollToSection = (id) => {
    ...
    if (target) {
      ...
      // Section doesn't exist in the current DOM — we're likely on the auth
      // screen, not the landing page. Go back to landing, then scroll once
      // it's mounted, instead of silently doing nothing.
      onLogoClick();
